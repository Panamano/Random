...
let n = Math.floor(Math.random() * facts.length - 1);

const day = new Date();
currentDay.textContent = day.toLocaleString(window.navigator.language, {weekday: 'long'});

funFact.textContent = facts[n];
